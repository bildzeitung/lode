...
After that, retrieval is fully offline; indexing still makes one small metadata call per
process to record which model revision produced the vectors (`HF_HUB_OFFLINE=1` skips it too).

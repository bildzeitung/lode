...
Full walkthrough — prerequisites (**jq** is required, not optional), the venv, the `bd init` commit you must drop, rtk exclusions, and the user-scope pieces that do *not* travel: **[`docs/onboarding.md`](docs/onboarding.md)**.

...
> how the workflow was to be validated, not work to pick up. **This supersedes the "delete it once the
> result is recorded" exit condition below: do not delete this file.** Full source if it is ever
> reconstructed:
